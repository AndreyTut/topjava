    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action == null ? "all" : action) {
            ...
            case "filter":
                ...
                LocalDate startDate = request.getParameter("fromDate").equals("") ?
                        null : LocalDate.parse(request.getParameter("fromDate"));
                LocalDate endDate = request.getParameter("toDate").equals("") ?
                        null : LocalDate.parse(request.getParameter("toDate"));
                LocalTime startTime = request.getParameter("fromTime").equals("") ?
                        null : LocalTime.parse(request.getParameter("fromTime"));
                LocalTime endTime = request.getParameter("toTime").equals("") ?
